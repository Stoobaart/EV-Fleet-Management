...
export function AssignmentModal({
  ...
  const drivers = !isAssigned && Array.isArray(data?.data) ? data.data : [];

  return createPortal(
    <div
      className="assignment-modal__overlay"
      onClick={onClose}
    >
      <div
          ...
          <ErrorBoundary>
            {isDriversError ? (
              <p className="assignment-modal__error">
                ...
                <button
                  className="assignment-modal__retry"
              ...
              <p className="assignment-modal__empty">
